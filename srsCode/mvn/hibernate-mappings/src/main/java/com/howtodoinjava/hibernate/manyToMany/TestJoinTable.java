...
//		session.getTransaction().commit();
		...
		Query q = session.createQuery("From ReaderEntity ");

		List<ReaderEntity> resultList = q.list();

		q = session.createQuery("From SubscriptionEntity ");

		List<SubscriptionEntity> rl = q.list();
